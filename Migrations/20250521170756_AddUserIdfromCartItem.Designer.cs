...
namespace TechnologyCommerce.Migrations
{
    ...
    [Migration("20250521170756_AddUserIdfromCartItem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechnologyCommerce.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TechnologyCommerce.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechnologyCommerce.Models.Cart", b =>
                {
                    b.HasOne("TechnologyCommerce.Models.ApplicationUser", "User")
                        .WithOne("Cart")
                        .HasForeignKey("TechnologyCommerce.Models.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TechnologyCommerce.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("TechnologyCommerce.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("TechnologyCommerce.Models.OrderDetail", b =>
                {
                    b.HasOne("TechnologyCommerce.Models.Order", "Order")
                        .WithMany("OrderItems")
